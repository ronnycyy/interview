...
(function (process) {
  ...
  // 所有核心模块都被编译进 node 二进制文件里，以便它们更快地被加载。
  ...
  // 加载 Node.js 内置模块，如 fs，位于 ~/lib/fs.js。
  NativeModule.require = function (id) {
    ...
    // 缓存一下
    nativeModule.cache();
    // 得到 JS 源代码以后, 用 '(function (exports, require, module, __filename, __dirname) { ', '\n});' 包裹，形成一段闭包代码。
    // 然后传入 vm 中运行。
    // 这就是把 JavaScript 代码编译进 Node.js 二进制文件的过程。
  ...
  NativeModule.prototype.compile = function () {
    // 获取该模块的源码，返回 NativeModule._source 数组的相应内容。
    ...
    try {
      ...
      // 没有正在加载了
      // 这个挺巧妙的，loading 代表加载完了没，loaded 代表是否加载成功。
      this.loading = false;
    }
  };
